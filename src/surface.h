...
struct Surface {
  ...
  virtual void Mx(double* mx, const int p, const double* u, const double* const* X) const = 0;
  virtual void Mux(double* mux, const int p, const double* u, const double* const* X) const = 0;
  virtual void Mvx(double* mvx, const int p, const double* u, const double* const* X) const = 0;
